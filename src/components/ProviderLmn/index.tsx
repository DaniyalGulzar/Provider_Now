...
const ProviderLmn = () => {
  ...
  const currentItems = requestProviderlmn.slice(
    indexOfFirstItem,
    indexOfLastItem
  );
  return (
    <>
      <AuthWrapper>
        <div className="p-4 mx-8">
          ...
          {/* {requestProviderlmn.length > 0 && (
            <Pagination
              totalItems={requestProviderlmn.length}
